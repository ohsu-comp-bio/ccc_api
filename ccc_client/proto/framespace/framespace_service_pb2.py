...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='framespace',
  syntax='proto3',
  serialized_pb=_b('\n)proto/framespace/framespace_service.proto\x12\nframespace\x1a!proto/framespace/framespace.proto\x1a\x1cgoogle/api/annotations.proto\"I\n\x11SearchAxesRequest\x12\r\n\x05names\x18\x01 \x03(\t\x12\x11\n\tpage_size\x18\x02 \x01(\x05\x12\x12\n\npage_token\x18\x03 \x01(\t\"M\n\x12SearchAxesResponse\x12\x1e\n\x04\x61xes\x18\x01 \x03(\x0b\x32\x10.framespace.Axis\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"\x92\x01\n\x16SearchKeySpacesRequest\x12\x14\n\x0ckeyspace_ids\x18\x01 \x03(\x05\x12\r\n\x05names\x18\x02 \x03(\t\x12\x1e\n\x04\x61xis\x18\x03 \x01(\x0b\x32\x10.framespace.Axis\x12\x0c\n\x04keys\x18\x04 \x03(\t\x12\x11\n\tpage_size\x18\x05 \x01(\x05\x12\x12\n\npage_token\x18\x06 \x01(\t\"[\n\x17SearchKeySpacesResponse\x12\'\n\tkeyspaces\x18\x01 \x03(\x0b\x32\x14.framespace.KeySpace\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"D\n\x12SearchUnitsRequest\x12\x10\n\x08unit_ids\x18\x01 \x03(\x05\x12\r\n\x05names\x18\x02 \x03(\x05\x12\r\n\x05types\x18\x03 \x03(\t\"O\n\x13SearchUnitsResponse\x12\x1f\n\x05units\x18\x01 \x03(\x0b\x32\x10.framespace.Unit\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"\x8e\x01\n\x17SearchDataFramesRequest\x12\x15\n\rdataframe_ids\x18\x01 \x03(\t\x12\x14\n\x0ckeyspace_ids\x18\x02 \x03(\x05\x12\x1f\n\x05units\x18\x03 \x03(\x0b\x32\x10.framespace.Unit\x12\x11\n\tpage_size\x18\x04 \x01(\x05\x12\x12\n\npage_token\x18\x05 \x01(\t\"^\n\x18SearchDataFramesResponse\x12)\n\ndataframes\x18\x01 \x03(\x0b\x32\x15.framespace.DataFrame\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"\x81\x01\n\x15SliceDataFrameRequest\x12\x14\n\x0c\x64\x61taframe_id\x18\x01 \x01(\t\x12(\n\tnew_major\x18\x02 \x01(\x0b\x32\x15.framespace.Dimension\x12(\n\tnew_minor\x18\x03 \x01(\x0b\x32\x15.framespace.Dimension2\xf3\x04\n\x11\x46rameSpaceService\x12m\n\nSearchAxes\x12\x1d.framespace.SearchAxesRequest\x1a\x1e.framespace.SearchAxesResponse\" \x82\xd3\xe4\x93\x02\x1a\"\x15/v1/frame/axes/search:\x01*\x12\x81\x01\n\x0fSearchKeySpaces\x12\".framespace.SearchKeySpacesRequest\x1a#.framespace.SearchKeySpacesResponse\"%\x82\xd3\xe4\x93\x02\x1f\"\x1a/v1/frame/keyspaces/search:\x01*\x12q\n\x0bSearchUnits\x12\x1e.framespace.SearchUnitsRequest\x1a\x1f.framespace.SearchUnitsResponse\"!\x82\xd3\xe4\x93\x02\x1b\"\x16/v1/frame/units/search:\x01*\x12\x85\x01\n\x10SearchDataFrames\x12#.framespace.SearchDataFramesRequest\x1a$.framespace.SearchDataFramesResponse\"&\x82\xd3\xe4\x93\x02 \"\x1b/v1/frame/dataframes/search:\x01*\x12p\n\x0eSliceDataFrame\x12!.framespace.SliceDataFrameRequest\x1a\x15.framespace.DataFrame\"$\x82\xd3\xe4\x93\x02\x1e\"\x19/v1/frame/dataframe/slice:\x01*b\x06proto3')
  ,
...
_SEARCHKEYSPACESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='axis', full_name='framespace.SearchKeySpacesRequest.axis', index=2,
...
_SEARCHUNITSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='unit_ids', full_name='framespace.SearchUnitsRequest.unit_ids', index=0,
      number=1, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='types', full_name='framespace.SearchUnitsRequest.types', index=2,
...
_SEARCHKEYSPACESREQUEST.fields_by_name['axis'].message_type = proto_dot_framespace_dot_framespace__pb2._AXIS
